...
namespace Lab04_TicTacToe.Classes
{
  class Player
  {
    ...
    /// <summary>
    /// retrieves postion play selects
    /// if position is invalid
    /// asks player to select again
    /// </summary>
    /// <param name="board">takes in the object board
    /// which is the game area</param>
    /// <returns></returns>
    ...
    /// <summary>
    /// returns coordinates based on user input
    /// </summary>
    /// <param name="position">positions available
    /// are 1-9</param>
    /// <returns></returns>
    ...
    /// <summary>
    /// asks for player to make a selection
    /// stores it to check for victory conditions
    /// and checks it space is already occupied
    /// </summary>
    /// <param name="board">object game area</param>
